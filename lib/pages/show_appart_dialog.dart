...
class AppartDialog {
              ...
              child: Wrap(
                children: [
                  TextButton(onPressed: () => Navigator.of(context).pop(),
                      child: Text('Annuler')),
                  ElevatedButton(
                      onPressed: () => onSubmit(context, _keyForm, _file, _appartName, _appartDescription,_appartPrice, _appartLocation, user),
                      child: Text('Publier'))
                ],
              ),
            )
  ...
  void onSubmit(context, keyForm, file, appartName,appartDescription, appartPrice, appartLocation, user) async {
